...
./vendor/bin/wp-deployer deploy pronamic-pay-gravitforms https://github.com/pronamic/wp-pronamic-pay-gravitforms.git -vvvv --branch main --non-interactive --to-s3
