...
class Pronamic_Gateways_IDealAdvanced_XML_TransactionRequestMessage extends Pronamic_Gateways_IDealAdvanced_XML_RequestMessage {
	...
	public function getDocument() {
		...
		self::addElement( $document, $element, 'amount', Pronamic_WordPress_IDeal_Util::amount_to_cents( $transaction->getAmount() ) );
	...
	public function getSignValues() {
		return array(
			...
			Pronamic_WordPress_IDeal_Util::amount_to_cents( $this->transaction->getAmount() ),
